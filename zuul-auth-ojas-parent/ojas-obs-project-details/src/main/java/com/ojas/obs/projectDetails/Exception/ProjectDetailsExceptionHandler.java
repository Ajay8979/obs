...
public class ProjectDetailsExceptionHandler {
	...
	public ResponseEntity<Object> handleProjectDetailsNotFound(
		...
		return new ResponseEntity<Object>(new ErrorResponse("422", projectDetailsException.getMessage()),HttpStatus.UNPROCESSABLE_ENTITY);
	}
	@ExceptionHandler(InvalidFormatException.class)
	public ResponseEntity<Object> handleInvalidFormat(
			InvalidFormatException invalidFormatException) {

		return new ResponseEntity<Object>(new ErrorResponse("422", "InvalidFormatException"),HttpStatus.UNPROCESSABLE_ENTITY);
	}
	@ExceptionHandler(TransactionException.class)
	public ResponseEntity<Object> handleInvalidFormat(
			TransactionException transactionException) {

		return new ResponseEntity<Object>(new ErrorResponse("422", "TransactionException"),HttpStatus.UNPROCESSABLE_ENTITY);
	}
}
