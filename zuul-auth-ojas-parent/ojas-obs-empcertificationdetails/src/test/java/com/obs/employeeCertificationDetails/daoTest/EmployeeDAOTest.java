...
public class EmployeeDAOTest {
	...
	public void saveTest() throws SQLException {
		...
		certiRequest.setSessionId("1214");
	...
	@Test
	public void deleteNegativeTest() throws SQLException {
		certiRequest = new CertificationDetailsRequest();
		certiRequest.setCertificationDetailsModel(getModel());
		certiRequest.setTransactionType("save");
		certiRequest.setSessionId("1214");
	...
	public void getAllTest() throws SQLException {
		certiRequest = new CertificationDetailsRequest();
		certiRequest.setCertificationDetailsModel(getModel());
		when(jdbcTemplate.query("fghfgh",new BeanPropertyRowMapper<CertificationDetails>(CertificationDetails.class))).thenReturn(getModel());
		List<CertificationDetails>num=employeeCertificationDAOImpl.getAllCertificationDetails();
	...
	public void getAllCountPerPageTest() throws SQLException {
		...
		int count=4;
		when(jdbcTemplate.queryForObject("select count(*) from obs_CertificationDetails where flag= true",Integer.class)).thenReturn(count);
		List<CertificationDetails>num=employeeCertificationDAOImpl.getCountPerPage(getModel(),2,3);
		boolean status=num.isEmpty();
		assertEquals(false,status );
