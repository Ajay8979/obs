...
public class UserConstants {
	...
	public static final String UPDATEBANKDETAILS = "Update obs_bankdetails set bank_account_no=?,bank_name=?, bank_city=?,bank_branch=?, bank_ifsc_code=?, bank_account_status=?, Is_active=?,updated_by=?,updated_date=?,flag=? where id = ? ";
