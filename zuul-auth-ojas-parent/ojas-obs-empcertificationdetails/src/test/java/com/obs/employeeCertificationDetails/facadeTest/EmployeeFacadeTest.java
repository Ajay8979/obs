 ...
 * 
 * 
 * @Before public void init() { employeeFacadeImpl= new
 * CertificationDetailsFacadeImpl(); employeeCertificationDAOImpl=
 * mock(EmployeeCertificationDAOImpl.class);
 * setCollaborator(employeeFacadeImpl,"employeeCertificationDAOImpl",
 * employeeCertificationDAOImpl); } private void setCollaborator(Object object,
 * String name, Object service) { Field field; try { field =
 ...
 * 
 * @Test public void saveTest() throws SQLException { certiRequest = new
 * CertificationDetailsRequest();
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("save");
 * when(employeeCertificationDAOImpl.saveCertificationDetails(certiRequest)).
 * thenReturn(true);
 * when(employeeCertificationDAOImpl.getAllCertificationDetailsCount()).
 * thenReturn(4); ResponseEntity<Object>
 * saveCertificate=employeeFacadeImpl.setCertificationDetails(certiRequest);
 * HttpStatus statusCode = saveCertificate.getStatusCode();
 * assertEquals(HttpStatus.OK, statusCode);
 * 
 * }@Test public void saveTestNegative() throws SQLException { certiRequest =
 ...
 * }
 * 
 * @Test public void updateTest() throws SQLException { certiRequest = new
 * CertificationDetailsRequest();
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("update");
 * when(employeeCertificationDAOImpl.updateCertificationDetails(certiRequest)).
 * thenReturn(true);
 * when(employeeCertificationDAOImpl.getAllCertificationDetailsCount()).
 * thenReturn(4); ResponseEntity<Object>
 * updateCertificate=employeeFacadeImpl.setCertificationDetails(certiRequest);
 * HttpStatus statusCode = updateCertificate.getStatusCode();
 * assertEquals(HttpStatus.OK, statusCode);
 * 
 * }
 * 
 * @Test public void updateTestNegative() throws SQLException { certiRequest =
 * new CertificationDetailsRequest();
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("update");
 * when(employeeCertificationDAOImpl.updateCertificationDetails(certiRequest)).
 ...
 * when(employeeCertificationDAOImpl.deleteCertificationDetails(certiRequest)).
 * thenReturn(true);
 * when(employeeCertificationDAOImpl.getAllCertificationDetailsCount()).
 * thenReturn(4); ResponseEntity<Object>
 * deleteCertificate=employeeFacadeImpl.setCertificationDetails(certiRequest);
 * HttpStatus statusCode = deleteCertificate.getStatusCode();
 * assertEquals(HttpStatus.OK, statusCode);
 * 
 * }
 * 
 * @Test public void deleteTestNegative() throws SQLException { certiRequest =
 * new CertificationDetailsRequest();
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("delete");
 * when(employeeCertificationDAOImpl.deleteCertificationDetails(certiRequest)).
 ...
 * }
 * 
 * @Test public void transactionTypeNullCheckForSave() throws SQLException {
 ...
 * thenReturn(false);
 * when(employeeCertificationDAOImpl.getAllCertificationDetailsCount()).
 * thenReturn(2); ResponseEntity<Object>
 * certificate=employeeFacadeImpl.setCertificationDetails(certiRequest);
 * HttpStatus statusCode = certificate.getStatusCode();
 * assertEquals(HttpStatus.CONFLICT, statusCode); }
 * 
 * @Test public void transactionInvalid() throws SQLException { certiRequest =
 * new CertificationDetailsRequest();
 * certiRequest.setCertificationDetailsModel(getModel());
 ...
 * assertEquals(HttpStatus.CONFLICT, statusCode); }
 * 
 * @Test public void getTest() throws SQLException { certiRequest = new
 * CertificationDetailsRequest(); List<CertificationDetails> certificateList =
 * new ArrayList<CertificationDetails>(); CertificationDetails model = new
 * CertificationDetails(); certificateList.add(model);
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("get");
 * when(employeeCertificationDAOImpl.getAllCertificationDetails()).thenReturn(
 * certificateList);
 * when(employeeCertificationDAOImpl.getAllCertificationDetailsCount()).
 * thenReturn(4); ResponseEntity<Object>
 * getCertificate=employeeFacadeImpl.getCertificationDetails(certiRequest);
 * HttpStatus statusCode = getCertificate.getStatusCode();
 * assertEquals(HttpStatus.OK, statusCode);
 * 
 * }
 * 
 * @Test public void getNullRecordTest() throws SQLException { certiRequest =
 * new CertificationDetailsRequest(); List<CertificationDetails> certificateList
 * = new ArrayList<CertificationDetails>(); //CertificationDetails model = new
 * CertificationDetails(); //certificateList.add(model);
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("get");
 ...
 * }
 * 
 * @Test public void getNullPeginationTest() throws SQLException { certiRequest
 * = new CertificationDetailsRequest(); List<CertificationDetails>
 * certificateList = new ArrayList<CertificationDetails>(); CertificationDetails
 * model = new CertificationDetails(); certificateList.add(model);
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("get"); certiRequest.setPageNo(0);
 ...
 * }
 * 
 * @Test public void getNotNullPeginationTest() throws SQLException {
 * certiRequest = new CertificationDetailsRequest(); List<CertificationDetails>
 * certificateList = new ArrayList<CertificationDetails>(); CertificationDetails
 * model = new CertificationDetails(); certificateList.add(model);
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("get"); certiRequest.setPageNo(1);
 ...
 * }
 * 
 * @Test public void getAllCountTest() throws SQLException { certiRequest = new
 * CertificationDetailsRequest(); List<CertificationDetails> certificateList =
 * new ArrayList<CertificationDetails>(); CertificationDetails model = new
 * CertificationDetails(); certificateList.add(model);
 * certiRequest.setCertificationDetailsModel(getModel());
 ...
 * }
 * 
 * @Test public void zeroCountTest() throws SQLException { certiRequest = new
 * CertificationDetailsRequest(); List<CertificationDetails> certificateList =
 * new ArrayList<CertificationDetails>(); CertificationDetails model = new
 * CertificationDetails(); certificateList.add(model);
 * certiRequest.setCertificationDetailsModel(getModel());
 * certiRequest.setTransactionType("get_count");
 * when(employeeCertificationDAOImpl.getAllCertificationDetailsCount()).
 * thenReturn(0); ResponseEntity<Object>
 * getCertificate=employeeFacadeImpl.getCertificationDetails(certiRequest);
 * HttpStatus statusCode = getCertificate.getStatusCode();
 * assertEquals(HttpStatus.CONFLICT, statusCode);
 * 
