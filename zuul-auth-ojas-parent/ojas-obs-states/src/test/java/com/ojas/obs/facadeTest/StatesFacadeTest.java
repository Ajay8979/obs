...
public class StatesFacadeTest {
	@InjectMocks
	StatesFacadeImpl statesFacadeImpl;
	@Mock
	...
	public void updateTest() throws SQLException {
		...
		ResponseEntity<Object> updateGender=statesFacadeImpl.setStates(statesRequest);
		HttpStatus statusCode = updateGender.getStatusCode();
		assertEquals(HttpStatus.OK, statusCode);
	...
	/*
	 * @Test public void deleteTest() throws SQLException { statesRequest = new
	 * StatesRequest(); statesRequest.setStates(getModel());
	 * statesRequest.getStates().get(0).setId(1);
	 * statesRequest.getStates().get(0).setUpdatedBy(123);
	 * statesRequest.setTransactionType("delete");
	 * when(statesDAOImpl.deleteStates(statesRequest)).thenReturn(true);
	 * ResponseEntity<Object>
	 * deleteGender=statesFacadeImpl.setStates(statesRequest); HttpStatus statusCode
	 * = deleteGender.getStatusCode(); assertEquals(HttpStatus.OK, statusCode);
	 * 
	 * }
	 * 
	 * @Test public void deleteNegativeTest() throws SQLException { statesRequest =
	 * new StatesRequest(); statesRequest.setStates(getModel());
	 * 
	 * statesRequest.setTransactionType("delete");
	 * when(statesDAOImpl.deleteStates(statesRequest)).thenReturn(false);
	 * ResponseEntity<Object>
	 * deleteGender=statesFacadeImpl.setStates(statesRequest); HttpStatus statusCode
	...
	public void transactionTypeNullCheckTest() throws SQLException {
		...
		when(statesDAOImpl.saveStates(statesRequest)).thenReturn(false);
		ResponseEntity<Object> deleteGender=statesFacadeImpl.setStates(statesRequest);
		HttpStatus statusCode = deleteGender.getStatusCode();
		assertEquals(HttpStatus.CONFLICT, statusCode);
	...
	public void getAllForNullListTest() throws SQLException {
		...
		statesRequest.setTransactionType("dfdhfgh");
		statesRequest.setPageNo(1);
		statesRequest.setPageSize(2);
		when(statesDAOImpl.getAll(statesRequest)).thenReturn(null);
		ResponseEntity<Object> getAllGender=statesFacadeImpl.getStates(statesRequest);
		HttpStatus statusCode = getAllGender.getStatusCode();
		assertEquals(HttpStatus.OK,statusCode );
	...
	public void getAllWithPagePageSizeTest() throws SQLException {
		...
		statesRequest.setPageNo(1);
		statesRequest.setPageSize(2);
		when(statesDAOImpl.getAll(statesRequest)).thenReturn(getModel());
		ResponseEntity<Object> getAllGender=statesFacadeImpl.getStates(statesRequest);
		HttpStatus statusCode = getAllGender.getStatusCode();
		assertEquals(HttpStatus.OK,statusCode );
	...
	public void getAllWithNoPeginationTest() throws SQLException {
		...
		statesRequest.setStates(getModel());
		statesRequest.setTransactionType("dfdhfgh");
		statesRequest.setPageNo(0);
		statesRequest.setPageSize(0);
		when(statesDAOImpl.getAll(statesRequest)).thenReturn(getModel());
		ResponseEntity<Object> getAllGender=statesFacadeImpl.getStates(statesRequest);
		HttpStatus statusCode = getAllGender.getStatusCode();
		assertEquals(HttpStatus.OK,statusCode );
