 ...
 * 
 * @Before public void init() { subBusinessUnitDaoImpl = new
 ...
 * subBusinessUnit1.setCostCenterId(123); SubBusinessUnit subBusinessUnit2 = new
 * SubBusinessUnit(); subBusinessUnit2.setId(2);
 * subBusinessUnit2.setName("sunil"); subBusinessUnit2.setBusinessUnitId(123);
 * subBusinessUnit2.setCostCenterId(123); List<SubBusinessUnit>
 * subBusinessUnit1List = new ArrayList<>();
