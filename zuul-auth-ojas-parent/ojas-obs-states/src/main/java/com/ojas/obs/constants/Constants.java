...
public class Constants {
	...
	/* public static final String STATES = "/obs/states"; */
		...
		//==================================== states ==================================================
				...
				public static final String INSERT_STATES = "insert into obs_states(stateName) values(?)";
				public static final String UPDATE_STATES ="update obs_states set stateName= ?  where id= ?";
				//public static final String DELETE_STATES ="update obs_states set flag=0 where id = ?";
				public static final String SELECT_STATES = "select * from obs_states";
				public static final String SELECT_STATES_BY_ID ="select * from obs_states ";
