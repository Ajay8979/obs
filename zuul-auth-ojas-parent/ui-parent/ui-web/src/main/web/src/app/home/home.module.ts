...
@NgModule({
  ...
  [
    ...
    HrReportsComponent, AdminRoleComponent, HrRoleComponent, EmployeeRoleComponent, CareerComponent, JobDescriptionComponent, PersonaldetailComponent, LeaveComponent, 
