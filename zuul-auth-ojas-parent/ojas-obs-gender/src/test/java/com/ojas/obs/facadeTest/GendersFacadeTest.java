...
public class GendersFacadeTest {
	@InjectMocks
	GenderFacadeImpl genderFacadeImpl;
	@Mock
	...
	public void init() {
		...
		setCollaborator(genderFacadeImpl,"genderDAOImpl",genderDAOImpl);
	}
	...
	public void updateTest() throws SQLException {
		...
		when(genderDAOImpl.getAllCount(genderRequest)).thenReturn(4);
		ResponseEntity<Object> updateGender=genderFacadeImpl.setGender(genderRequest);
	...
	/*
	 * @Test public void deleteTest() throws SQLException { genderRequest = new
	 * GenderRequest(); genderRequest.setGender(getModel());
	 * genderRequest.setTransactionType("delete");
	 * when(genderDAOImpl.deleteGender(genderRequest)).thenReturn(true);
	 * when(genderDAOImpl.getAllCount(genderRequest)).thenReturn(4);
	 ...
	 */
	/*
	 * @Test public void deleteNegativeTest() throws SQLException { genderRequest =
	 * new GenderRequest(); genderRequest.setGender(getModel());
	 * genderRequest.setTransactionType("delete");
	 * when(genderDAOImpl.deleteGender(genderRequest)).thenReturn(false);
	 * when(genderDAOImpl.getAllCount(genderRequest)).thenReturn(4);
	 * ResponseEntity<Object>
	 * deleteGender=genderFacadeImpl.setGender(genderRequest); HttpStatus statusCode
	 ...
	 */
	/*
	 * @Test public void transactionTypeTest() throws SQLException { genderRequest =
	 * new GenderRequest(); genderRequest.setGender(getModel());
	...
	public void getAllTest() throws SQLException {
		...
		genderRequest.setPageSize(2);
		when(genderDAOImpl.getAll(genderRequest)).thenReturn(getModel());
		when(genderDAOImpl.getAllCount(genderRequest)).thenReturn(4);
		ResponseEntity<Object> getAllGender=genderFacadeImpl.getGender(genderRequest);
	...
	public void getAllForNoPeginationTest() throws SQLException {
		...
		genderRequest.setGender(getModel());
		genderRequest.setTransactionType("dfdhfgh");
		genderRequest.setPageNo(0);
		genderRequest.setPageSize(0);
		when(genderDAOImpl.getAll(genderRequest)).thenReturn(getModel());
		when(genderDAOImpl.getAllCount(genderRequest)).thenReturn(4);
		ResponseEntity<Object> getAllGender=genderFacadeImpl.getGender(genderRequest);
		HttpStatus statusCode = getAllGender.getStatusCode();
